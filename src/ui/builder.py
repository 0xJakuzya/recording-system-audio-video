...
def build_ui(root, on_toggle_recording, on_place_marker):
    ...
    cam_status, mic_status, status_dot, status_txt = _build_header(outer, fonts)
    ...
    timer_var = _build_timer(outer, fonts)
    ...
    log_frame, log_canvas, empty_label = _build_log(outer, fonts)
